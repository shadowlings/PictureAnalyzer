...
using BlazorSpinner;
using PictureAnalyzer.Client;
using PictureAnalyzer.Client.Services;
...
var configuration = await  _tempHttpClient.GetFromJsonAsync<PictureAnalyzer.Common.Configuration>("api/v1/configuration");
builder.Services.AddSingleton<PictureAnalyzer.Common.Configuration>(configuration);
#endregion
